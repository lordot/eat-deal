    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cafes', to='promos.city')),
            ],
        ),
        migrations.CreateModel(
            name='Promo',
            fields=[
                ...
                ('cafe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='promos', to='promos.cafe')),
                ('days', models.ManyToManyField(to='promos.day')),
                ('tags', models.ManyToManyField(to='promos.tag')),
            ],
            options={
